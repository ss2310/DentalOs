-- ============================================================
-- GrowthOS — COMBINED: migrations 052 + 053 in one paste.
-- Run this whole file in the Supabase SQL editor, then run:
--   notify pgrst, 'reload schema';
-- (053 redefines record_payment/log_visit from 052 with receipt
--  numbers — the later definitions win; running both is correct.)
-- ============================================================

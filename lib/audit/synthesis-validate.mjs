 ...
 *  - minItems=14, maxItems=20, themeCap=7, quickWinBy=7, topGapBy=7
 *    (a 30-day plan across ~4 weeks; "early" = the first week, days 1-7)
...
export function validateSynthesis(json, opts = {}) {
  ...
  for (let i = 0; i < plan.length; i++) {
    ...
    if (!Number.isInteger(day) || day < 1 || day > maxDay) {
      return fail(`${at} day_number must be an integer 1-${maxDay}`);
    }
